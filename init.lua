...
vim.keymap.set(nv_mode, 'n', 'h', ns_opts)
vim.keymap.set(nv_mode, 'u', 'k', ns_opts)
vim.keymap.set(nv_mode, 'e', 'j', ns_opts)
vim.keymap.set(nv_mode, 'i', 'l', ns_opts)
vim.keymap.set(nv_mode, 'N', '^', ns_opts)
vim.keymap.set(nv_mode, 'I', 'g_', ns_opts)
vim.keymap.set(nv_mode, 'h', 'nzz', ns_opts)
vim.keymap.set(nv_mode, 'j', 'e', ns_opts)
vim.keymap.set(nv_mode, 'k', 'i', ns_opts)
vim.keymap.set(nv_mode, 'l', 'u', ns_opts)
vim.keymap.set(nv_mode, 'K', 'I', ns_opts)
vim.keymap.set(nv_mode, 'H', 'Nzz', ns_opts)
vim.keymap.set(nv_mode, 'U', '5k', ns_opts)
vim.keymap.set(nv_mode, 'E', '5j', ns_opts)
vim.keymap.set(nv_mode, 'S', ':w<cr>', ns_opts)
vim.keymap.set(nv_mode, 'Q', ':q<cr>', ns_opts)
